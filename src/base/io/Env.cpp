...
{
    variables.insert({ "VELOXHASH_VERSION",  APP_VERSION });
    variables.insert({ "VELOXHASH_KIND",     APP_KIND });
    variables.insert({ "VELOXHASH_HOSTNAME", Env::hostname() });
    variables.insert({ "VELOXHASH_EXE",      Process::exepath() });
    variables.insert({ "VELOXHASH_EXE_DIR",  Process::location(Process::ExeLocation) });
    variables.insert({ "VELOXHASH_CWD",      Process::location(Process::CwdLocation) });
    variables.insert({ "VELOXHASH_HOME_DIR", Process::location(Process::HomeLocation) });
    variables.insert({ "VELOXHASH_TEMP_DIR", Process::location(Process::TempLocation) });
    variables.insert({ "VELOXHASH_DATA_DIR", Process::location(Process::DataLocation) });
