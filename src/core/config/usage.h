...
static inline const std::string &usage()
{
    ...
    u += "  -a, --algo=ALGO               mining algorithm name\n";
...
#   endif
    ...
    u += "      --donate-level=N          donation level, disabled by default in VeloxHash\n";
    u += "      --donate-over-proxy=N     control donation over proxy feature\n";
...
#   ifdef XMRIG_FEATURE_CUDA
    ...
    u += "      --cuda-loader=PATH        path to CUDA plugin library\n";
