...
#define APP_ID        "veloxhash"
#define APP_NAME      "VeloxHash"
#define APP_DESC      "VeloxHash miner"
#define APP_VERSION   "6.25.0"
#define APP_DOMAIN    "veloxhash.local"
#define APP_SITE      "veloxhash.local"
#define APP_COPYRIGHT "Copyright (C) 2026 VeloxHash"
